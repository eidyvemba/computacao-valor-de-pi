...
# ----------------------------------------------  --- ---
plt.figure("Grafico - Valor de Pi - Serial")
...
# ----------------------------------------------  --- ---
plt.figure("Grafico - Tempo de Execucao - Serial")
...
plt.figure("Grafico Lambert - Valor de Pi - Serial")
plt.plot(numTermosLambert,valorPiLambert, label = "Lambert", c='r')
plt.legend()
plt.legend(loc=0)
plt.title("Grafico de Compraracao em Relacao ao Valor de Pi")
...
plt.figure("Grafico Lambert - Tempo de Execucao - Serial")
plt.plot(numTermosLambert,tempoExecLambert, label = "Lambert", c='r')
plt.legend()
plt.legend(loc=2)
plt.title("Tempo de Execucao")
...
plt.figure("Grafico Leibniz - Valor de Pi - Serial")
plt.plot(numTermosLeibniz,valorPiLeibniz, label = "Leibniz", c='g')
plt.legend()
plt.legend(loc=0)
plt.title("Grafico de Compraracao em Relacao ao Valor de Pi")
...
plt.figure("Grafico Leibniz - Tempo de Execucao - Serial")
plt.plot(numTermosLeibniz,tempoExecLeibniz, label = "Leibniz", c='g')
plt.legend()
plt.legend(loc=2)
plt.title("Tempo de Execucao")
...
plt.figure("Grafico Viete - Valor de Pi - Serial")
plt.plot(numTermosViete,valorPiViete, label = "Viete", c='b')
plt.legend()
plt.legend(loc=0)
plt.title("Grafico de Compraracao em Relacao ao Valor de Pi")
...
plt.figure("Grafico Viete - Tempo de Execucao - Serial")
plt.plot(numTermosViete,tempoExecViete, label = "Viete", c='b')
plt.legend()
plt.legend(loc=2)
plt.title("Tempo de Execucao")
...
plt.figure("Grafico Nilakantha - Valor de Pi - Serial")
plt.plot(numTermosNilakantha,valorPiNilakantha, label = "Nilakantha", c="#FF9800")
plt.legend()
plt.legend(loc=0)
plt.title("Grafico de Compraracao em Relacao ao Valor de Pi")
...
plt.figure("Grafico Nilakantha - Tempo de Execucao - Serial")
plt.plot(numTermosNilakantha,tempoExecNilakantha, label = "Nilakantha", c="#FF9800")
plt.legend()
plt.legend(loc=2)
plt.title("Tempo de Execucao")
